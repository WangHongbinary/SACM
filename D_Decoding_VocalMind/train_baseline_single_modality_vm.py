...
LastEditTime: 2025-12-23 14:06:32
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datatype', type=str, default='Processed_sEEG_Vocalized_Word', help='Data type, Processed_sEEG_Vocalized_Word')
    parser.add_argument('--class_num', type=int, default=20, help='Number of categories, automatically determined based on label_type')
    parser.add_argument('--time_sample_num', type=int, default=600, help='Number of time samples for each SEEG segment')
    ...
    parser.add_argument('--model_path', type=str, default=f'{os.path.dirname(__file__)}/model_save_single_modality_vm/', help='Path to save Model')
    parser.add_argument('--log_path', type=str, default=f'{os.path.dirname(__file__)}/log_save_single_modality_vm/', help='Path to save log')
    parser.add_argument('--matrix_label_path', type=str, default=f'{os.path.dirname(__file__)}/matrix_label_save_single_modality_vm/', help='Classification confusion matrix label save path')
