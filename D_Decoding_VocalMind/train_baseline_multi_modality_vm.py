...
LastEditTime: 2025-12-23 12:22:47
Description: Baseline model training code (multi_modality, VocalMind)
'''
...
def train_baseline(args):
    ...
    audio_proj = Audio_Proj(in_dim=768, out_dim=args.out_dim, in_time=args.in_time, out_time=args.out_time).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--class_num', type=int, default=10, help='Number of categories, automatically determined based on label_type')
    parser.add_argument('--feature_type', type=str, default='Sentencehubertraw_8', help='Audio feature type')
    parser.add_argument('--chn', type=int, default=8, help='Number of SEEG channels')
    parser.add_argument('--time_sample_num', type=int, default=1000, help='Number of time samples for each SEEG segment')
    ...
    parser.add_argument('--in_time', type=int, default=249, help='Input time length of audio feature projection')
    ...
    parser.add_argument('--model_path', type=str, default=f'{os.path.dirname(__file__)}/model_save_multi_modality_vm/', help='Path to save Model')
    parser.add_argument('--log_path', type=str, default=f'{os.path.dirname(__file__)}/log_save_multi_modality_vm/', help='Path to save log')
    parser.add_argument('--matrix_label_path', type=str, default=f'{os.path.dirname(__file__)}/matrix_label_save_multi_modality_vm/', help='Classification confusion matrix label save path')
