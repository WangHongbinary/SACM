...
def ml_clf(args):
    ...
    train_index = np.hstack(np.array(train_index))
    test_index = np.hstack(np.array(test_index))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='/mnt/data1/whb/Ours/SACM_Data/processed', help='Path to load the audio features')
